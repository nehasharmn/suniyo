      ...
      <div className="container mx-auto px-6 max-w-5xl">
        <div className="flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="flex-shrink-0 flex flex-col items-center">
            <div className="relative">
              ...
              <img
                ...
                className="relative w-56 h-56 object-cover object-top rounded-full border-4 border-white shadow-xl"
              />
            </div>
            <div className="mt-3 inline-flex items-center gap-2 bg-teal-50 border border-teal-200 text-teal-700 text-xs font-semibold px-3 py-1 rounded-full">
          ...
          <div className="flex-1 text-center md:text-left">
            <p className="text-teal-600 font-semibold text-sm uppercase tracking-widest mb-2">Meet Your DeskBuddy</p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {capabilities.map(({ icon: Icon, label }) => (
                <div key={label} className="flex flex-col items-center md:items-start gap-2 bg-slate-50 border border-slate-100 rounded-xl px-4 py-3">
