...
export default function Pricing() {
  ...
  return (
    <div className="bg-white min-h-screen">
      {/* Header */}
      <div className="bg-gradient-to-br from-teal-50 via-white to-cyan-50 pt-32 pb-16">
        <div className="container mx-auto px-6 max-w-5xl text-center">
          <p className="text-teal-600 font-semibold text-xs uppercase tracking-widest mb-3">Simple, Transparent Pricing</p>
      ...
      <div className="container mx-auto px-6 max-w-5xl py-16">
        ...
        <div className="mb-16">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-2xl p-8 flex flex-col md:flex-row items-center gap-8">
            <div className="flex-shrink-0 w-16 h-16 bg-teal-100 rounded-2xl flex items-center justify-center">
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            {/* Monthly */}
            <div className={`rounded-2xl border-2 p-8 transition-all ${billing === 'monthly' ? 'border-teal-400 bg-teal-50 shadow-lg' : 'border-slate-200 bg-white opacity-60'}`}>
              <div className="mb-6">
                <p className="text-xs font-semibold text-teal-600 uppercase tracking-widest mb-2">Flexible Plan</p>
              ...
              {billing === 'monthly' && (
                <Link to="/Subscribe">
                  <button className="w-full bg-teal-500 hover:bg-teal-600 text-white font-bold px-6 py-3 rounded-full text-sm transition-colors">
                    Get Started →
                  </button>
                </Link>
              )}
            ...
            {/* Annual */}
            <div className={`rounded-2xl border-2 p-8 transition-all relative ${billing === 'annual' ? 'border-teal-400 bg-teal-50 shadow-lg' : 'border-slate-200 bg-white opacity-60'}`}>
              <div className="mb-6">
                <p className="text-xs font-semibold text-teal-600 uppercase tracking-widest mb-2">Best Value</p>
              ...
              <p className="text-teal-600 text-sm font-semibold mb-4">Just $250/month — Save $1,200</p>
